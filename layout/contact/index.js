...
function Contact() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (userRef.current) {
      emailjs
        .sendForm("service_nbxoym8", "future_labs", userRef.current, {
          publicKey: "g3rfi3XdxWimj0V_V",
        })
        .then(
          () => {
            console.log("SUCCESS!");
  ...
  return (
    ...
    >
      <Typography variant="large" sx={{ textAlign: "center", fontWeight: 700 }}>
        Contact Us
      </Typography>
      <form onSubmit={handleSubmit} ref={userRef}>
        <Grid
          container
          my={2}
          sx={{
