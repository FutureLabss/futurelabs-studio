  ...
  const videos = [
    {
      ...
      text3: "With the power of 3D Art, all we do is imagine and recreate a better future for all",
      text2: "",
    ...
    },
    {
      ...
      text1: "Reinvent",
      text3: " What if a 12 year old genius re-imagined the future of urban transportation, flying cars, drones and vertical takeoffs?",
      text2: "",
    ...
    },
    {
      ...
      text1: "Attention",
      text3: "What’s a 3D Art without attention to details and photorealism?",
    ...
    },
    {
      link: "https://res.cloudinary.com/usenmfon/video/upload/v1650975960/FutureLabs/All_3D_video_bxracl.mp4",
      text1: "Boundless",
      text3: "Who could you be, what could you create if resources where boundless?",
      text2: "",
      poster: "/images/modelling_1.webp",
      button: "",
      showAudio: true,
    },
    {
      ...
      text1: "Clarity",
      text3: "With our 3D models, you have clarity on what you want to build before you start building",
