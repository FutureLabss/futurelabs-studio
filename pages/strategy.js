...
const videos = [
  ...
  },
  {
    ...
    text2: "This generation is only fascinated by results,  let’s help you go from ideas to MVPs rapidly",
  ...
  },
  {
    ...
    text1: "Bringing You Project 1000",
    text2: "We partnered with American Cybersecurity experts to train young minds with digital skills, as a means to fight cyber fraud",
...
function StrategyPage() {
  ...
  return (
    <>
      <Head>
          <title>Strategy - Futurelabs studio</title>
